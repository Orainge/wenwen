...
// callback_func: 加载完成后需要执行的函数, ex_script: 额外添加的js, ex_css: 额外添加的css
window.onload = function () {
    sourceLoad() //只能这样写，会引起错误
}
