...
var timer1 = null
var timer2 = null
var loginButton, registerButton
var loginLoading, registerLoading
...
$(function () {
    ...
    registerSuccessMessage = $("#register-success-message")

    $('#login-reset_password').on('click', function () {
        sendReset()
    })

    $('#login-resend_email').on('click', function () {
        sendActivate()
    })
